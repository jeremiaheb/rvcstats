...
SSU = setRefClass("SSU",
                     fields = list(num = "numeric", len = "numeric", species_cd = "factor", species_nr = "numeric",
                     time_seen = "factor", station_nr = "numeric", depth = "numeric",
...
SSU$methods(
  ...
  ## of length zero
  initialize = function(num, len, species_nr, species_cd, station_nr, time_seen, depth = numeric(0), 
